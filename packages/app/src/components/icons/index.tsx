...
export const Diagram = lazy(async () => import('./DiagramIcon'))
export const AddNode = lazy(async () => import('./AddNodeIcon'))
export const AddGroup = lazy(async () => import('./AddGroupIcon'))
export const AddText = lazy(async () => import('./AddTextIcon'))
